...
| **Bed pit** | Operational | Respawn anchor; reed/willow/grass; acceptable sleep |
...
|--------|----------------|
| Start and maintain fire (bow drill) | Smelt or forge metal |
| Cook on stone / boil in bark cup | Pottery or crucibles |
| Catch small fish (weir) | Reliable large protein |
| Gather snails, pistachios | Preserve food at scale |
| Cut, dig, lash, weave ( crude ) | Tan hides or weave cloth |
| Store goods (shelf, pit, basket) | Weatherproof shelter |
| Survey and mark land | Plant crops (fence first) |
| Knapp chert flakes | Repeatable charcoal |
| Identify local plants P-01–P-11 | Domesticated agriculture |
| Bank seed selection | Process olive oil or wine |
