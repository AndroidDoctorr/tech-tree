...
**Day 517 · Cal-Y2 D280:** **KITCHEN-UTENSIL-BUNDLE ✓ · CU-SKILLET-1 · POT-KITCHEN-1 green**
**Day 516 · Cal-Y2 D279:** **KITCHEN-FLOOR-LAY ✓ · boot PASS · PIT-CHAR-26 · cosmetic queue**
**Day 515 · Cal-Y2 D278:** **FLOOR-TILE-FIRE-6 ✓ · KITCHEN-FLOOR-LAY-1 ~65% checker**
**Day 514 · Cal-Y2 D277:** **FARM-READ GREEN · FLOOR-TILE-FIRE-5 · GOAT-HUNT window filed**
...
| **Glass stack** | **TRIAL-3 clearer bead ✓ · 70/30 blend works · ANNEAL-1 tray ✓** |
| **Campus QoL** | LM-2 · kitchen · crane · +bowls — interleave farm |
| **Transport** | **AXLE-CART-1 ✓** · **CART-BED** after nails · barrow frame spare |
...
| **IRON-AXE/ADZE/CHISEL/WEDGE/NAILS** | **✓** |
| **CU-* suite** | **✓** · smelt on hold |
| **MEASURE-1 · FORGE-PPE-1 · SPEAR-2 · bow ×16** | **✓** |

## Can do / cannot yet

| Can do | Cannot yet |
|--------|------------|
| Hero iron forge with vault backup | Bronze (no tin) |
| Bloom/weld/tool pipeline proven | Clear glass / vessel routine |
| Micro glass melt (bead class) | Window · lens · production furnace |
| Three pitched amphorae · tile roof W-1 | Full anvil block (hardy · horn) |
| ANVIL-MASS-1 forge · barn iron hinges+latch mounted | Homogeneous steel · case-harden (pack path queued) |
| Drawn copper wire · spool storage | Uniform wire at telegraph scale |
| **EXPED-C** | **✓ Phase 1 + Phase 2 complete** |
| Wire path | **DRAWPLATE ✓ · WIRE-DRY-1 ✓ · ~2.6 m vaulted** |
| Chem/dye | **MORDANT-TRIAL-1 ✓** · **ALUM-PURIFY-1 ~157 g** |
| Clothing | **Full dress stack** — breech · tunic · tabard · shoes · **rotation queued post-pull** |
| Textiles | **THREAD-STOCK-2 ~182 m** · **DYE-PANEL-1 ✓** · **line ~121 g** · **BLANKET-1 horizon** |
| Lodestone | **LODE-CORE-1 · MAGNET-PAN-1 · LODE-SUSPEND proof** · **COMPASS-1 horizon** |
| Bow / down | **BOW-PRACTICE-1 ✓** — evening blunt doctrine · down = autumn molt |
| **EXPED-M22-1** | **✓ closed** — body + haul + home |
