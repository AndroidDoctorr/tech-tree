# Building Code 1 *(BC-1)*

**Filed:** Day 1759 · **Cal-Y6 D61** · **Player standard — campus-wide retrofit before new stakes**  
**Scope:** All **enclosed heated/work buildings** @ HOME campus and future stakes  
**Stock / grammar:** [inventory.md](../../inventory/index.md) · [craft-wing-plan.md](../../government/archive/craft-wing-plan.md) · [house-plan.md](../../government/archive/house-plan.md) · [chem-lab-plan.md](../../government/archive/chem-lab-plan.md)

---

## Intent

Bring **existing structures up to BC-1** before new ground stakes. Atelier is the **reference finish-out** for clean wings; Domus and Fabrica ranges already meet large parts of this code — **windows (metal + glass)** and **portico/mudroom rigor** are the main retrofit gaps.

**Side project (parallel, not blocking farm):** **WINDOW-UPGRADE-1** — all windows → **metal strap frames + glass panes** · oak/shutter grammar acceptable interim (**Atelier ✓ sealed wood v1 d1758**).
...
| Rule | Standard |
|------|----------|
| **Walls** | **Single-wythe brick mures** (or rubble-lime core where bath grammar demands) · **bond beam** @ head |
| **Roof** | **TR tile** primary · **shingle class** acceptable when **decent TR/reed pitch** proven *(portico · temp sheds)* · drip PASS mandatory |
| **Interior finish** | **Limewash** minimum · **paint** optional @ clean wings |
| **Heat** | **Indirect** — hub plenum / hypocaust stub / wing cheek · **no open hearth in pigment/oil wings** |
| **Vent** | **Ridge hood · louvers · operable shutters** · cross-draft tested where hearth/wet work |

### Windows *(target · interim wood OK)*

| Rule | Target | Interim |
|------|--------|---------|
| **Frame** | **Metal strap casement** · seats in **SEAL-GROOVE / jamb reveal** | **Oak lintel · sill · jamb · batten shutter** |
| **Glazing** | **Glass panes** · KILN-C / GP pane class · lead or oak bead grid | **Open shutter · seal v1** |
| **Seal** | **Hide/wool + reed felt @ groove · M-08 sill/head bead** | **✓ required now** |
| **Shade** | **Awning** @ exterior over each glazed aperture | **Reed/canvas · portico grammar** |

### Doors

| Rule | Standard |
|------|----------|
| **Hardware** | **Brass handle + brass hinges** (iron retired @ clean entries when upgraded) |
| **Seal** | **Weather strip v1** — hide/wool · reed felt · M-08 pitch @ sill · **DOOR-SEAL grammar** |
| **Entry** | **No direct exterior-to-clean-room** — **portico or mudroom airlock** minimum · **coir or woven rug @ threshold** |

### Entry airlock *(portico / mudroom)*

| Element | Required |
|---------|----------|
| **Roof / rain break** | Reed + pitch or tile eave extension |
| **Boot brush / scrape** | Coir mat or equivalent @ threshold |
| **Coat pegs** | Minimum ×2 @ temp portico class |
...
## WINDOW-UPGRADE-1 *(side project slate)*
...
**TR tile** = BC-1 default roof. **Reed + M-08 pitch** (portico / temp class) = acceptable **non-habitable airlock** roof. **Wood shingle** = **not live** — defer until **STORE-4 shake-split** or dedicated shingle sprint proves **drip PASS** at pitch; until then **TR or reed-pitch only**.

---

## New stakes rule

**No new enclosed wing stakes** until **named retrofit pass** closes BC-1 gaps on **Atelier + one Fabrica wing + Domus entry class** *(player may waive per stake — default hold)*.
...
| **Worn default** | **Steel kitchen knife · iron/steel edge tools** — see [inventory/tools-lab.md](../../inventory/tools.md) |
