# Chem lab wing — WW-YARD annex

**Filed:** Day 656 · **Cal-Y3 D54**  
**Priority:** **Before Domus H-V3 stake** — separate structure · science + storage clock  
**Site:** [WW-YARD-1](map.md) · east add-on to **MILLHOUSE-1** marker  
**Stock:** [inventory.md](inventory.md) · **Brick pipeline:** [house-plan.md](house-plan.md)

---

## Why this before the domus

| Reason | Notes |
|--------|-------|
| **Separate clock** | Lab + workshop ≠ villa — no respawn or comfort coupling |
| **Technique ramp** | Stone socle · single wythe · vent stack · aqueduct branch — **practice at smaller scale** |
| **Tool refuge** | Bigger lab wing holds **full millhouse tool set** while original wing is demolished/rebuilt |
| **Science gate** | Glass · insulation · reagents · wire experiments need **CHEM-LAB-1** not v1 floor clutter |
| **Mechanize path** | Ladder **comfort + science speed-run:** AQUEDUCT ✓ → **CHEM-LAB** → factory → bucket |
...
|------|-------------|--------|
| **MILLHOUSE-1** | **~3×4 m** (12 m²) | **✓ Phase 1** — open workshop · roof mat |
| **CHEM-LAB-WING-1** | **~5×6 m** (30 m²) | **Staked Day 656** — **stone socle first** |
| **MILLHOUSE-2** *(mirror)* | **~5×6 m** | **Deferred** — replaces torn Phase 1 after lab live |

**Campus shape when done:** Simple **rectangle pair** (~5×12 m class footprint) flanking **BELT** line — easy north/south extension later.
...
| Stage | Target | Notes |
|-------|--------|-------|
| **0** | **Stake + drain** | **✓ Day 657** — east of HOUSE marker · belt clearance · drain E |
| **1** | **Stone socle** | **✓ Day 661** — FS-12–18 full perimeter · frost-class course · level closed |
...
**Live rule:** One wing roofed at a time — **never** two open timber frames without cover in wet season.

**Layout doctrine:** Wall courses use **plumb bob + straight edge + square** (formal **LAYOUT-KIT-1** queued). Angles filed in **TURN-fractions** (¼·½·¾ turn), not degrees.

---

## CHEM-LAB-1 interior zones

| Zone | Need |
|------|------|
| **Floor** | **Tile bed** — lime-sand grout · spill containment · *after shelves/cabinets layout fixed* |
| **Counters / benches** | **Pompeii-class** grouted **tile or dressed stone** tops — heat + chem resistant · **minimal wood** (legs/frame only) |
| **Shelf** | Wall tiers · reagent jars · ash · lime · verdigris · **POT-LAB-SET-1** |
| **Cabinet** | **Closed** oak carcases · **iron strap hinges** (BARN-HINGE grammar) · pitch/glue · desiccant / wire stock |
| **Sink** | Aqueduct branch · slop drain · glaze wash |
| **Fire** | Peripheral **tile/stone** table · charcoal meter · **not** forge hero |
| **Vent** | Hood · ridge slot · cross-draft north · **FAN-PROVISION** *(see below)* |
| **Dry** | **WIRE-DRY-1** class cabinet · desiccant |
| **Labware** | **Now:** ceramic + copper/iron · **Later:** glass vessels · better alloys |

### Vent — fan provision *(filed Day 704 · retcon Day 703 hood)*

The north hood box was built **oversize** with a **reserved chase** above the louver row:
...
## Stage 5 interior plan *(filed Day 704)*

**Doctrine:** **Few wood surfaces.** Oak for **frames, brackets, door stiles** only — tops and floors are **tile/stone**.
...
| **Better metals** | **H-11 ore ✓ · tin ✗** | Bronze waits scout · iron maintenance honest |

**Verdict:** **Upgrade Kiln C + forge lining** before building a new fancy furnace. Interior lab does **not** require furnace work first.

### Surface doctrine — not tile everywhere *(filed Day 710)*

| Zone | Best surface | Why |
|------|--------------|-----|
| **Floor** | **Fired LF tile** + lime-sand grout bed | Spill containment · wipe · acid splash class |
| **Counters / benches** | **Pompeii-class grouted tile or dressed stone slab** | Heat + chem · **not** wood tops |
| **Walls** | **Lime plaster skim + whitewash** | **Bright · smooth · light bounce** — cheaper than full tile |
| **Lower wall belt** *(optional later)* | **Tile wainscot ~1 m** | Splash zone only · not whole room |
| **Fire table** | **Tile or stone top** | Peripheral · charcoal meter |
| **Wood** | **Frames only** ✓ | Shelves · cab carcases — oiled · not limed |
| **Ceiling / roof** | **Fired roof tile** ✓ | Already closed Stage 4 |
...
## Tin geography *(correction Day 656)*

**TIN-SCOUT-1** target class: **Cilician coast @ Tarsus** → **Taurus mountains north of the coastal plain** (pegmatite / stream cassiterite). **Not** local **Amanus NE** (ice · iron scout ridge). Reach = **coast + boat/scout** horizon — see [map.md — Tin corridor](map.md).

---

*Chem lab before villa. Stone first. Mirror later. Factory feeds the hoard.*
