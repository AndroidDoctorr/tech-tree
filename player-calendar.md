...
Cal-Y · solstice-synced Gregorian · repeats every year · [sun-calendar.md](sun-calendar.md)
...
- **Feb – Apr** — **Goat kidding / freshen window** *(if doe bred prior rut · stall prep · **milk/cheese NO-GO until freshen** · milk stand defer until post-kid)*
- **8 Feb** — Ice max haul (peak)
- **10 Feb** — Ice max haul (peak)
- **14 Feb** — Ice haul tail
...
- **1 Dec – 10 Dec** — **Olive oil decant / settle** *(amphora crude · kitchen oil draw)*
- **10 Dec** — **Olive oil press window closes** *(before feast band · oil settle / amphora)*
- **16 Dec** — Olive pick · madder root dig season ends *(last table-olive stray lap for brine)*
- **20 Dec** — Feast eve −1
- **21 Dec** — Yule / Feast
- **22 Dec** — Year opens
...
--- **Jun–Jul wild/patch margin** + **Nov–Dec field strip post-harvest** · rett pool serial · rafter queue when pool busy.
...
**Wild-only (calendar hero):** **P-01 pistachio T-2** · **P-12 fig @ 650 m** · **P-02 olive terrace ~600 m** (oil/brine hero Nov).

**Planned:** **OLIVE-GROVE-EXPAND-Y7** — P-02 cuttings · pit plant · spring or autumn band.

**Parsley:** **not catalogued @ campus** — forage laps d1689–d1691 never logged it · **spring plant only after named seed scout** · no retcon.