# Player roster — characters & skills

**Archetypes, not stereotypes:** each person has **one strong lane**, **one blind spot**, and **something unrelated** that makes them human (grief, humor, vanity, faith, kid at home).
...
|--|--|
| **Drop** | **Nile fringe (#2)** |
| **Was** | Line cook / prep lead, 41; three kids; knows food cost down to the penny |
| **Archetype** | Cooperator · morale · preservation intuition |
...
| | |
|--|--|
| **Drop** | **Zagros foothills (#5)** |
| **Was** | UPS driver + serious Midwest bow hunter, 48 |
...
| | |
|--|--|
| **Drop** | **North European lake (#9)** |
| **Was** | Carpenter + volunteer firefighter, 44; Sweden via Minnesota |
| **Archetype** | Builder · cold-country pragmatist |
| **Strong** | Timber frame, smoke sauna logic, preservation culture, axe safety |
...
|--|--|
| **Drop** | **Sahel edge (#8)** |
| **Was** | Logistics coordinator for an NGO, 32; used to moving supplies where roads don't |
| **Archetype** | Navigator · organizer · no romanticism about wilderness |
| **Strong** | Routes, water timing, group discipline, spotting liars |
...
| | |
|--|--|
| **Drop** | **Cilician coast (#4)** |
| **Was** | HVAC / industrial electrician, 39; dad taught him to weld |
| **Archetype** | Systems mechanic · bellows brain · forge future |
...
| | |
|--|--|
| **Drop** | **Andes altiplano (#10)** |
| **Was** | Watchmaker / micro-mechanic, 29; hiker; speaks little in groups |
| **Archetype** | Late joiner · fine motor · isolation extreme |
| **Strong** | Cordage, traps, patience, copper needle–class work, astronomical notice |
...
## The point (draft theme)

**Observers aren't testing one genius.** They're testing whether **strangers with complementary gaps** can rebuild **without exterminating each other** — and whether Earth deserves contact **as a we**, not a hero.

Solo players fail or stall; **cooperation is the hidden win metric** (see [../premise/game-rules.md](../premise/game-rules.md)).
