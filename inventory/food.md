...
| `PARCHED-MU-12` | Parched emmer · green | ~0.52 kg | `P-μ-12` | d3124 | d3124 |
| `BARREL-4-GRAIN` | Cracked grain, working | ~0.50 kg | `BARREL-4`, v1 | d3123 | d3123 |
...
| `FISH-SMOKE-1` | Smoked fish | ~1.11 kg | Smoke rack, pool | ? | d3145 |
| `GOOSE-SMOKE-1` | Smoked goose | ~0.79 kg | Horreum A smoke shelf | ? | d3146 |
...
| ID | Item | Qty | Where | Made | Last |
|---|---|---|---|---|---|
| `OIL-Y9-1` | Olive oil, clear · **cook live** | ~1.59 L | Glass bottles · working draw ~390 ml at `P-ξ-5` | d3117 | d3145 |
...
| ID | Item | Qty | Where | Made | Last |
|---|---|---|---|---|---|
| `GRAPE-MUST-Y9-1` | Grape must, fermenting | ~2.23 L | `AMPHORA-9` | d3099 | d3145 |
| `GRAPE-MUST-Y7-1` | Grape must, matured · vinegar-ready | ~1.6 L | Horreum | Y7 | d2346 |
| `VINEGAR-Y6-1` | Vinegar · Y8 fork top-up ~0.65 L | — | `AMPHORA-5` · `P-ξ-4` · crock | Y6 | d2704 |
...
| ID | Item | Qty | Where | Made | Last |
|---|---|---|---|---|---|
| `SALT-1` | Salt | ~10.05 kg | Larder · `P-μ-9` · `P-μ-11` | | d3115 |
| `SPICE-MU-10` | Spice | — | `P-μ-10`, horreum A margin | | — |
| `MINT-CROCK-1` | Mint | — | Crock | | d3175 |

Salt is the one indefinite row. Evaporation is closed for the winter and reopens in the March band — `EVAP-RACK-1` in [infrastructure.md](infrastructure.md).
