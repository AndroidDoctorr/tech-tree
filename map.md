...
| **COAST-SITE-1** | **~20 km W** | **~20 km** | **~4 h** | Beach · kelp source · sand · **M-11 mark** |
...
| **Kiln B** | **Brick / tile / amphora factory** | Operational — see inventory for counts |
| **Kiln C** | **Metal furnace** | Twin bellows; copper smelt **on hold** |
...
| | |
|--|--|
| **Role** | **Dry store** — food · ore · lime · chemistry · **SEED-VAULT** |
...
| **Haul @ home** | — | **KELP-ASH-1** · coast sand — see [inventory.md](inventory.md) |
...
*Build history: [journal/index.md](journal/index.md) · weekly rollups in [journal/weeks/](journal/weeks/). Update when trails, sites, or built structures change.*
