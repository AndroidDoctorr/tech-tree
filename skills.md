...
*Last updated: **Day 370** (~10,000 BC) · doctrine revision — player = you, not blank slate*
...
| **Now @ d370** | Current total — **Start + in-world practice**. Not “game-only XP.” |
...
| Skill | Start (IRL) | Now @ d370 | Δ | Notes |
|-------|-------------|------------|---|-------|
| **Machine sewing** (tunics 10+, togas 2) | **4** | **4** | — | Pattern sense · **not** spindle/loom transfer. |
| **Hand sewing / lash / stitch** | **2–3** | **3** | +0–1 | Leather · tabard · caligae · wattle ties. |
...
| **Weaving (loom)** | **1** | **3** | **+2** | **LM-1** · panels · **TOWEL-1** · basic tabby. |
| **Fulling / boil finish** | **1** | **2** | +1 | Towel path proved · garment pipeline open. |
| **Felt / wool** | **0** | **0** | — | No sheep. |
| **Dye / mordant chemistry** | **2** | **2** | — | Alum marked · mordant not in hand. |
...
| **Circuits · motor · electroplating** | **4** theory | **2** | — | **EM path** future · hands barely touched. |
...
| **Iron tool forge** | **0–1** | **3** | **+2** | Axe · adze · chisel · wedge · nails · **hammer ✓ d367**. |
...
| **Glass precursors** | **0** | **1** | +1 | KELP-ASH · sand · quartz stacked · **no melt**. |
...
| **Wood carving** | **2** | **3** | +1 | **WOOD-CARVE-368** · iron adze hollow · IRL + bench time. |
| **Crane / heavy lift** | **1** | **1** | — | **CRANE-1** queued · theory + theater rigging sense. |
...
| Skill | Start (IRL) | Now @ d370 | Δ | Notes |
|-------|-------------|------------|---|-------|
| **Bow use** (composite · recurve · PVC) | **3** | **3** | — | **Bow v1** · **×16 (12 pointed)** · live practice sparse. |
