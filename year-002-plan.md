...
## Year 2 north stars (player guideposts @ Day 367)
...
## EXPED-C — multi-site ore & chemistry haul

### Known sources

| ID | Material | Dist | Status | EXPED-C task |
|----|----------|------|--------|--------------|
| **M-G1** | Malachite **O-1** | ~27 km NE | **Proven** · **~12.5 kg** home · smelt on hold | **Top-up haul** — 1–2 travois/donkey loads class |
| **H-11** | Hematite **O-IRON-1** | ~11 km NE | **Proven** · **~1.8 kg** home after blooms | **HAUL-IRON-2** — primary iron restock |
| **M-11** | Alum (alunite) | ~20 km W cliff | **Mark-only Day 200** @ COAST-SITE-1 | **Collect** — mordant · glass/chem path |
| **M-22** | Magnetite | NE forks (RS-3) | **Weak sign Day 95** · **~15 g grit Day 131** | **Resurvey + confirm** — don't commit hero haul blind |

### Suggested arc (not calendar-fixed)

**Phase 1 — NE (Days 369–374) · ALL GREEN Day 368**

| Day | Leg |
|-----|-----|
| 369 | **LAUNCH → H-11** (~11 km) |
| 370 | **H-11 bench mine** — target **~8–12 kg O-IRON** · **IRON-HAMMER-1** + wedge |
| 371 | **Loaded → Camp-1** · **M-22 fork** probe ≤30 min |
...
3. **Malachite leg** — homeward if travois capacity
4. **Alum collect** — **Phase 2 separate**
5. **Home sort** — pile 4 zones relabeled Day 368

**Kit:** **TENT-1** · **BEDROLL-1** · **AMPHORA-1/2** water class · **TRAIL-CACHE-1** · **SPEAR-2** · bow · **YEARLING-1** if trained for load leg  
...
| Have | Need |
|------|------|
| **KELP-ASH-1 ~120 g** (soda class) | Furnace window > routine copper · controlled cool |
| **Coast sand ~2.2 kg** · **local quartz ~335 g** | Crucible discipline · **anneal** tray/sand bed |
...
| Item | Spec | Stock / prereq |
|------|------|----------------|
| **IRON-HAMMER-1** | **✓ Day 367 ~195 g** | Primary forge driver |
| **IRON-DRAWPLATE-1** | Iron plate · graduated holes · bench mount | **~120 g bloom** · **CHISEL-1** · **punch** |
| **ANVIL-1** | Horn · hardy hole · **>5 kg mass** class | **FS blocks** + iron cap **or** multi-bloom weld · **CRANE-1** helps set |
| **Wire (Cu first)** | Draw through plate · work-harden · anneal | Drawplate + **copper bar/peas** · EM horizon |

---

## Campus build queue (interleave — not one sprint)
...
## Transport decision (cart vs boat)
...
## Char doctrine (updated Day 367)

| Source | Use |
|--------|-----|
| **Pit char** | Forge lane refill · kiln factory · routine |
| **Vault Store C (~67 kg after Day 367)** | **Iron insurance** — authorized draw for hero forge when lane dead (Day 367 precedent) |
| **Rule** | Pit when dry + wood OK · vault when **hero iron** blocked · don't burn vault for nails/tiles |

---

## Season anchors (Cal-Y2)
...
| **Day ~237+365 = feast eve Cal-Y2 close** | **YULE-BENCH-2** · compare to Year 1 plate |
...
*Living doc — update after major unlocks. Daily log stays in [journal/days/](../journal/days/).*
