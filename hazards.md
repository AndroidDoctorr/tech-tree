...
**Why billion, not percent:** a **1%** floor is wrong for tornado-class events.  
...
python sim/roll.py check --day 3094 --hazard TORNADO-DAILY --threshold 2
...
| Key | Now @ d3094 | Notes |
|-----|-------------|-------|
| **rut_tension** | **68** | Per-rut FARM-CARE scare: threshold = `tension × 1_000_000` (68M ⇒ **6.8%**/scare) |
| **last_breed_day** | **107** | Kid #2 era · billie #2 junior · sex read **d2059** |
...
| **TORNADO-DAILY** | All year | **2** | **~1 in 500M** | Extreme wind funnel · structure hero |
| **QUAKE-DAILY** | All year | **50** | **~1 in 20M** | Tremor · kiln/brick read |

*Oct @ d3094:* roll **WEATHER-RAIN-LIGHT** + passive **TORNADO-DAILY** + **QUAKE-DAILY**.
