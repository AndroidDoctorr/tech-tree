...
| **Tabard** | ~55×38 cm · **lime whitewash** (sun) |
| **SHOE-2** | Double sole, cross-lace |
...
| **M-10 local** | **~335 g** | After **OPT-1-FORGE** ~45 g draw Day 250 |
...
| Location | Qty | Notes |
|----------|-----|--------|
| **Kiln pad hoard** | **~158** | **+9** Day 311 fire — maintenance met |
...
| Item | Qty | Notes |
|------|-----|--------|
| **Floor stones (FS)** | **0** in pile 8 | **32** laid on **H-v2** (~77% of pad goal) |
| **Limestone / calcite (pile 7)** | **~2.0 kg** | Clean sorted; shells supplement |
| **Copper slag dish** | 1 | Prills + pea fragments from smelts #3–9 |
| **Copper peas (stock)** | **~83 g** | Block **#17–20** + **CU-HOE-1** + **CU-FORGE-TONGS-1** · needle bank separate |
| **Charcoal Store C** | *(see Store C + CHAR lane)* | **~75 kg vault + ~4 kg lane ≈ ~79 kg @ home** |
...
| **Kiln C** | Copper smelt | P-δ · bellows · **O-1 ~6.9 kg** reserve · **smelt on hold** |
...
| **ROPE-2** | **~46 m** home @ pile 2 — ~6 m deployed TRAIL-CACHE-1 |
...
| **CU-FORGE-TONGS-1** | Millhouse FORGE peg |
