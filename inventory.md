...
| **CL-GLOVE-H v0** | Heat — layered (liner / hide / ash pad) |
...
| **Lyre (MUS-1)** | ~40% frame | **2** sinew strings — stored inside when wet |
...
| Location | Qty | Notes |
|----------|-----|--------|
| **Kiln pad hoard** | **113** | Day 126: **+9** (#31) |
| **Pile 3 / kiln yard** | **~112–115** | **Green** — **10** loaded kiln #30 Day 124 |
...
| **Copper peas (stock)** | **~12 g** | Smelt #12 **+~2.2 g** Day 149 (**+** needle **~1.1 g** separate) |
...
| **H-11 hematite samples** | cobble + chip | RS-3 Day 131 — **not** smelt feed |
...
| **Kiln C** | Copper smelt | P-δ · bellows · **~16.5 kg** ore fed from **O-1** |
...
| Item | Notes |
|------|--------|
| **LM-1 loom** | North bay — bands **#1–4** |
| **ROPE-1-A** | **~80 m @ D-27 CORRAL-1** *(was workshop peg — deployed Trip 3)* |
| **Wear cord** | **~8 m** on travois / bellows |
| **Arrow rack** | **×6** arrows |
| **Archery berm** | W-1 far end |
| **Leather / hide work** | Scrap, glue, frames |
| **Anvil / CU-KNIFE** maintenance | |
