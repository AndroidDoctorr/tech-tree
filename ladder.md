...
| **Big stable long-term store** (barn + pottery line) | · **BARN-1 Year 2** |
...
| Flax retting pool **P-RETT-1** | ✓ bundle 1 |
...
| **Drop spindle** · thread at scale | **~62 m coarse bank** · **~30 g coarse fiber** · **line hank separate** |
...
| **MILLHOUSE smelt kit** (ore · tongs · slag · charcoal lane) | ✓ **Block #17–20 ✓ Day 245** · **~127 g stock** |
...
| **Glass** melt + anneal | · needs hot furnace + soda + silica |
| **Glass vessels / optics** | · |
| Systematic **reagents lab** | · |
...
| **Glass / iron / bronze** — don't skip rungs | · queued |
...
*Update when a rung moves. Linked: [tech-tree.md](tech-tree.md) (long milestones) · [year-001-plan.md](year-001-plan.md) (Year 1 strategy).*
